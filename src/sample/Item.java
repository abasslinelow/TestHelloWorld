...
/**
 * Dictates that all products must have methods for getting id, as well as getting and setting the
 * product name and manufacturer. All Product objects to conform to this interface.
 */
